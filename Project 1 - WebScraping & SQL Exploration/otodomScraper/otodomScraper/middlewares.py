...
class OtodomscraperSpiderMiddleware:
...
class OtodomscraperDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
with open (r"F:\Library\Engineering\computer science\Data Science\portfolio projects\Project 2 - SQL Data Analytics\browser-headers.json", 'r') as file:
    headers_dict = json.load(file)
...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def _get_headers_list(self):
        ...
        # json_response = json.loads(headers_json)
        self.headers_list = headers_dict['result']
    ...
    #     if self.scrapeops_fake_browser_headers_active == False or self.scrapeops_api_key == None or self.scrapeops_api_key == '':
    ...
    def process_request(self, request, spider):
        ...
        # request.headers['referer'] = ' https://www.zillow.com/new-york-ny/rentals'
